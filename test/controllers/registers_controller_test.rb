...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { email: @register.email, first_name: @register.first_name, last_name: @register.last_name }
    end
  ...
  test "should update register" do
    patch :update, id: @register, register: { email: @register.email, first_name: @register.first_name, last_name: @register.last_name }
    assert_redirected_to register_path(assigns(:register))
  end
